    ...
    <div class="reviewform">
      <div class="">
        <section class="px-0 md:px-6 py-6">
          <form
            class="bg-white border border-gray-100 dark:bg-gray-900 dark:border-gray-900 md:rounded"
          >
            <div
            ...
            <div class="p-6">
              <div class="mb-6 last:mb-0 text">
                <label class="block font-bold mb-2 second"
                  >What is your opinion of QHelper's service?</label
                >
                <div class="flex justify-start flex-wrap -mb-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 checkbox"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <label class="checkbox mr-6 mb-3 last:mr-0 checkbox">
                    <input type="radio" name="sample-checkbox" value="bad" />
                    <span class="check"></span
                  ...
                  <label class="checkbox mr-6 mb-3 last:mr-0 checkbox">
                    <input type="radio" name="sample-checkbox" value="good" />
                    <span class="check"></span
              ...
              <hr
                class="my-6 -mx-6 border-t border-gray-100 dark:border-gray-700"
              />
              <div class="mb-6 last:mb-0 text">
                <label class="block font-bold mb-2 third"
                  >Please leave your feedback below:</label
                >
                <div class="textbox">
                  <div class="relative">
                    <grammarly-extension
                    ...
                    ></grammarly-extension>
                    <textarea
                      class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-24 border bg-white dark:bg-gray-800"
              ...
              />
              <div
                class="flex items-center justify-start flex-wrap -mb-3 fourth"
              >
                <button
