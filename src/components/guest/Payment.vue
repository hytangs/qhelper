    ...
    <div class="w-1/2 my-8 mx-auto">
          ...
          <div class="panel-inner">
            ...
            <div v-if="paymentOptions.creditCard" class="px-6 py-3 bg-gray-100">
              <label class="relative block">
                <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 h-14"
                       placeholder="Card number">
                <LockClosedIcon class="h-5 w-5 text-gray-400 absolute top-1/2 transform -translate-y-1/2 right-3"/>
              </label>
      ...
      <div class="bg-gray-100 border rounded mt-8 px-6 py-3">
        <label class="block mt-4">
          <select class="form-select mt-1 block w-full rounded-md border-gray-400 text-gray-400 h-14">
        ...
        <label class="block mt-3">
          <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 h-14" placeholder="Address">
        </label>
        <label class="block mt-3">
          <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 h-14"
        ...
        <label class="relative block mt-3">
          <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 h-14" placeholder="Phone">
          <QuestionMarkCircleIcon class="h-5 w-5 text-gray-400 absolute top-1/2 transform -translate-y-1/2 right-3"/>
        </label>
      </div>
      <!-- Billing Address end-->
    </div>
