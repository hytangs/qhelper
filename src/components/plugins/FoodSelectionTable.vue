<template>
  ...
  <table>
    ...
    <tr v-for="client in itemsPaginated" :key="client.id">
      ...
      <td data-label="Guest Name">{{ client.name }}</td>
      <td data-label="Room">{{ client.room }}</td>
      <td data-label="Food Selection">{{ client.selection }}</td>
      <td data-label="Special Request">{{ client.request }}</td>
...
import JbButtons from './JbButtons'
...
export default {
  ...
  setup () {
    ...
    const items = computed(() => store.state.foodselection)
